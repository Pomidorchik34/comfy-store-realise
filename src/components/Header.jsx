...
function Header() {
  ...
  function changeTheme(e) {
    ...
    if (i % 2 == 1) {
      ...
      return document.querySelector("html").setAttribute("data-theme", "light");
    }
  ...
  return (
    <div>
          ...
          {token.token && (
            <>
              <div className="flex justify-end text-white gap-5 items-center">
                ...
                <button
                  className="btn btn-outline btn-blue-700 btn-sm"
                  onClick={handleClick}
                >
                  LOGOUT
                </button>
      ...
      <div className=" bg-base-200">
        <div className="navbar container mx-auto px-24">
          ...
          <div className="navbar-end flex gap-4">
            <label onClick={changeTheme} className="swap swap-rotate">
